...
exports.isValidColor = exports.colorsByLength = exports.colors = void 0;
const colors = {
  black: '#000000',
  silver: '#C0C0C0',
  gray: '#808080',
...
const isValidColor = word => !!colors[word];
...
const displayColors = colors => colors.map(color => `<span class='color ${color} ${(0, _colors.isDark)(color) ? 'dark' : ''}' style='background: ${color}'>${color}</span>`).join('');
...
const start = () => {
  ...
  console.log('Starting...'); // make a new speech
